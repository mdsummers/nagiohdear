module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        "start": parse_start,
        "define_block": parse_define_block,
        "define_block_line": parse_define_block_line
      };
      ...
      function parse_define_block() {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result7 !== null) {
                      result8 = parse_define_block_line();
                      if (result8 !== null) {
                        if (/^[\r\n]/.test(input.charAt(pos))) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, lines) {
          return {
            name: name.join("").trim(),
      ...
      function parse_define_block_line() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, value, comment) {
          return {
            name: name.join("").trim(),
